    ...
    <div 
      ...
      <div className='w-full h-full grid grid-cols-[1fr_1fr] min-h-0'>
        <div className="overflow-y-auto">
          {activeTab === 'all' && <NestTable nests={nests} onRowClick={setSelectedNestId} selectedId={selectedNestId}/>}
          {activeTab === 'reported' && <ReportNestTable reports={reportedNests} onRowClick={setSelectedNestId} selectedId={selectedNestId}/>}
          {activeTab === 'comments' && <CommentTable comments={reportedComments} onRowClick={setSelectedNestId} selectedId={selectedNestId}/>}
        </div>
